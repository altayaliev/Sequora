...
[![Version](https://img.shields.io/badge/version-1.0.2-informational.svg)](#nuget-package)
...
Package id: **Sequora**. Current version: **1.0.2**. License: **MIT**.
...
Paket identifikatoru: **Sequora**. Cari versiya: **1.0.2**. Lisenziya: **MIT**.
...
| Simvollar | `Sequora.1.0.2.snupkg` |
